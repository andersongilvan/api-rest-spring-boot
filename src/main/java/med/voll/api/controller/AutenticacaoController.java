...
import med.voll.api.domain.usuario.DtoUsuario;
import med.voll.api.infra.security.DtoTokenJwt;
...
public class AutenticacaoController {
    ...
    @PostMapping
    public ResponseEntity efetuarLogin(@RequestBody @Valid DtoUsuario dados) {
       ...
       var dtoTokenJwt = new DtoTokenJwt(tokenJWT);
